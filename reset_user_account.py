#!/usr/bin/env python3
"""
Скрипт для полной очистки данных пользователя с telegram_id = '125030399'
Подключается к базе данных Render и удаляет все данные пользователя, но сохраняет запись в users
"""
...
# Данные подключения к БД Render
DB_CONFIG = {
