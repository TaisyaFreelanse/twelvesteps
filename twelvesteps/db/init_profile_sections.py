...
def init_profile_sections():
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            # Цели разделов описаны в файле profile_sections_goals.md
            sections_data = [
                # 👨‍👩‍👧 Семья - Понять семейную динамику: роли, травмы, поддержка, табу
                (1, '👨‍👩‍👧 Семья', '👨‍👩‍👧', False, None, 1),
                # 🧑‍🤝‍🧑 Друзья - Понять модели привязанности, границ, доверия, слияния или изоляции
                (2, '🧑‍🤝‍🧑 Друзья', '🧑‍🤝‍🧑', False, None, 2),
                # 🎓 Учёба - Понять отношение к интеллекту, опыту оценки, стыда, самооценке
                (3, '🎓 Учёба', '🎓', False, None, 3),
                # 🧒 Детство - Выявить ранние сценарии, светлые и травматические эпизоды
                (4, '🧒 Детство', '🧒', False, None, 4),
                # ❤️ Любимые занятия - Восстановить контакт с радостью, самостью, ресурсом
                (5, '❤️ Любимые занятия', '❤️', False, None, 5),
                # 🎯 Хобби - Понять, что приносит вдохновение, помогает быть в потоке
                (6, '🎯 Хобби', '🎯', False, None, 6),
                # 💼 Работа / Дело - Оценить отношение к деятельности, ответственности, успеху и выгоранию
                (7, '💼 Работа / Дело', '💼', False, None, 7),
                # 🤝 Поддержка рядом - Понять, на кого можно опереться. Выявить пробелы в поддержке
                (8, '🤝 Поддержка рядом', '🤝', False, None, 8),
                # 🕒 Режим и быт - Понять, насколько жизнь структурирована и где можно создать стабильность
                (9, '🕒 Режим и быт', '🕒', False, None, 9),
                # 🧭 Ценности и правила - Определить внутренние ориентиры. Понять, какие принципы сохраняют идентичность
                (10, '🧭 Ценности и правила', '🧭', False, None, 10),
                # 🛑 Границы и темы "пока не трогать" - Определить зоны уязвимости. Понять, как формируются психологические границы
                (11, '🛑 Границы и темы "пока не трогать"', '🛑', False, None, 11),
                # 💪 Сильные стороны - Выявить опорные качества и моменты внутренней силы
                (12, '💪 Сильные стороны', '💪', False, None, 12),
                # 🩺 Здоровье - Понять отношение к телу и самочувствию. Где есть тревога, избегание или неуслышанный сигнал организма
                (13, '🩺 Здоровье', '🩺', False, None, 13),
                # ✍️ Свободный рассказ - Свободный ввод текста без структурированных вопросов
