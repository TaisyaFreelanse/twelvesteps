...
STEP_TITLES = {
    ...
    11: {
        ...
        "description": "Путём молитвы и медитации мы стремились улучшить свой сознательный контакт с Богом, как мы Его понимаем, молясь лишь о знании Его воли для нас и о силе для её исполнения."
    },
    12: {
...
async def show_steps():
    ...
    async with async_session() as session:
        ...
        print("=" * 70)
        for step in steps:
            title = step.title or "❌ Без названия"
            print(f"Шаг {step.index:2}: {title}")
        print("=" * 70)
